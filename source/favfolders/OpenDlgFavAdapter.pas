...
begin
  ...
  begin
    ...
    if IsWin2k or IsWinXP or IsWinVista then
...
procedure TFavOpenDialog.HookDialogs;
  ...
  begin
    ...
    begin
      FHooks.HookImport(ModuleBase, comdlg32, 'GetOpenFileName', @NewGetOpenFileName, @OldGetOpenFileName);
      FHooks.HookImport(ModuleBase, comdlg32, 'GetSaveFileName', @NewGetSaveFileName, @OldGetSaveFileName);
