object frmSaveNewFile: TfrmSaveNewFile
  ...
  object btnDoNothing: TcxButton
    ...
    Anchors = [akRight, akBottom]
    Cancel = True
    Caption = 'Do nothing (Esc)'
    TabOrder = 12
    OnClick = btnDoNothingClick
    LookAndFeel.Kind = lfStandard
  end
  object chkSaveSeparate: TcxCheckBox
    Left = 262
    Top = 130
    Anchors = [akTop, akRight]
    Caption = 
      'save spec and body of PACKAGE/TYPE in files separate (additional' +
      'ly)'
    State = cbsChecked
    TabOrder = 1
    Width = 359
  ...
  object fsSaveNewFile: TJvFormStorage
    ...
    StoredProps.Strings = (
      'chkSaveSeparate.Checked'
      'edtTempDirectory.Text'
