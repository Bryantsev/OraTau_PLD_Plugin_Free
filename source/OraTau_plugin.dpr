...
uses
  ...
  OpenDlgFavAdapter in 'favfolders\OpenDlgFavAdapter.pas',
  ufrmSaveNewFile in 'ufrmSaveNewFile.pas' {frmSaveNewFile},
  ufrmSettings in 'ufrmSettings.pas' {frmSettings},
  ufrmQuickQuery in 'ufrmQuickQuery.pas' {frmQuickQuery};
